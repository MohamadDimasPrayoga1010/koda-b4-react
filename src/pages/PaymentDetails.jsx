  ...
  const handleCheckout = async () => {
    ...
    try {
      const payload = {
        ...
        paymentMethodId: paymentMethods.find((p) => p.name === selectedPayment)
          ?.id,
      ...
      if (!payload.paymentMethodId || !payload.shippingId) {
        setAlert({
          type: "error",
          message: "Please select delivery and payment method",
        });
      ...
      if (!res.success)
        throw new Error(res.message || "Failed to process transaction");
        ...
        {paymentSuccess && (
          <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm">
            <div className="bg-white p-10 rounded-2xl shadow-2xl text-center max-w-md transform animate-bounce-in border-2 border-[#D4C5B0]">
              ...
              <h2 className="text-3xl font-bold mb-3 text-[#654321]">
                Payment Successful!
              </h2>
              ...
              <div className="p-6 space-y-5">
                <div className="bg-[#F5F0E8] rounded-xl p-5 space-y-3 border border-[#D4C5B0]">
                  ...
                  <div className="flex justify-between items-center bg-white rounded-lg p-3 shadow-sm">
                    <p className="font-bold text-[#654321] text-lg">
                      Grand Total
                    </p>
                ...
                <div className="pt-4 border-t-2 border-[#D4C5B0]">
                  <p className="text-sm font-bold text-[#654321] mb-4 uppercase tracking-wide">
                    Payment Methods
                  </p>
